...
function SectionTwo() {
    return (
        <div className='min-h-[934px] w-full mb-[20px] flex flex-col justify-around items-center bg-[#2E2E2E] bg-no-repeat bg-left-bottom	' style={{ backgroundImage:`url(./blue.png)` }}>
                ...
                <div className='max-w-[400px] flex flex-wrap justify-around items-center sm:max-w-[1000px]'>
                 <div className='h-[160px] w-[182px] sm:mx-[40px] my-[40px] flex flex-col justify-around items-center bg-[#F7F7F7] border-1 border-[#1382C7] rounded-[9px]' >
                     <img src='../section/section1.png' />
                     <h2>Fresh Thoughts</h2>
                 </div>
                       
                 <div className='h-[160px] w-[182px] sm:mx-[40px] my-[40px] flex flex-col justify-around items-center bg-[#F7F7F7] border-1 border-[#1382C7] rounded-[9px]' >
                     <img src='../section/section2.png' />
                     <h2>Smooth onboarding</h2>
                 </div>
                 
                 <div className='h-[160px] w-[182px] sm:mx-[40px] my-[40px] flex flex-col justify-around items-center bg-[#F7F7F7] border-1 border-[#1382C7] rounded-[9px]' >
                     <img src='../section/section3.png' />
                     <h2>On time delivery</h2>
                 </div>

                    <div className='h-[160px] w-[182px] sm:mx-[40px] my-[40px] flex flex-col justify-around items-center bg-[#F7F7F7] border-1 border-[#1382C7] rounded-[9px]' >
                     <img src='../section/section4.png'/>
                     <h2>Promising Product</h2>
                 </div>
