        ...
        <section className='flex flex-wrap-reverse justify-center lg:justify-between items-center'>
          <div className='flex flex-col sm:justify-center items-center min-h-[800px] w-[100%] sm:w-[800px]'>
            <form className='max-w-[300px] w-[90%] sm:max-w-[600px]'>
              <input className='h-[40px] w-[90%] sm:w-[600px] text-primary bg-secondary border-b-2 border-[#1382C7] mt-10 p-2' placeholder='First Name'  type='text' />
              <input className='h-[40px] w-[90%] sm:w-[600px] text-primary bg-secondary border-b-2 border-[#1382C7] mt-10 p-2' placeholder='Last Name' type='text' />
              <input className='h-[40px] w-[90%] sm:w-[600px] text-primary bg-secondary border-b-2 border-[#1382C7] mt-10 p-2' placeholder='Company Name' type='text' />
